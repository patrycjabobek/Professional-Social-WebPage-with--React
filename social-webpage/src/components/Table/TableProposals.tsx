...
import {Wrapper, BigAvatar, StyledBlockContainer, SubTitle, Title,TableHeader} from '../../styledHelpers/Components';
...
export const TableProposals: FC<IProps> = (props) => {
                    ...
                    {!props.isEditable 
                        ?
                            (<TableRow>
                                ...
                                <TableColumn>{data.firm1}</TableColumn>
                            </TableRow>)
                        :   (<TableRow>
                                ...
                                <input type="text" value={data?.firm1} onChange={ev => setData({...data, firm1: ev.target.value})}/>
                        </TableRow>)
                    }
                    ...
                    {!props.isEditable 
                        ?
                            (<TableRow>
                                ...
                                <TableColumn>{data.firm2}</TableColumn>
                            </TableRow>)
                        :   (<TableRow>
                                ...
                                <input type="text" value={data?.firm2} onChange={ev => setData({...data, firm2: ev.target.value})}/>
                        </TableRow>)
                    }
                    {!props.isEditable 
                        ?
                            (<TableRow>
                                ...
                                <TableColumn>{data.firm3}</TableColumn>
                            </TableRow>)
                        :   (<TableRow>
                                ...
                                <input type="text" value={data?.firm3} onChange={ev => setData({...data, firm3: ev.target.value})}/>
                        </TableRow>)
                    }
            </Data>
        </StyledBlockContainer>
